...
const educacion = ref([
  {fecha: '2021', title: 'Bachiller en gestión y administración de empresa.', descripcion: 'CENS', enlace:''},
  {fecha: '2023', title: 'Tecnicatura en Extracciones', descripcion: 'FUDE', enlace:''},
  {fecha: '2023', title: 'Manicura Profesional', descripcion: 'FUDE', enlace:''},
  {fecha: '2024', title: 'Mujeres Programando Futuro', descripcion: 'Fundación Media', enlace:''},
  {fecha: '2024', title: 'Tecnicatura de Programación', descripcion: 'Cursando. UTN San Rafael.', enlace:''},
  ]);
</script>
