...
const experiencias = ref([
    { id: 1, src: icono1, parrafo: 'Experiencia en Panadería y Gastronomía. Ayudante de cocina y Atención al cliente en panadería' },
    { id: 2, src: icono2, parrafo: 'Experiencia en Servicios de Laboratorio Clínico. Extraccionista de sangre' },
    { id: 3, src: icono3, parrafo: 'Experiencia en estética de uñas' },
]);
</script>
