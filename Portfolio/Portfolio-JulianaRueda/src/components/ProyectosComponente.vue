...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "Portfolio Personal(2024)",
        descripcion: "Construí un portafolio personal con Vue.js",
        projectoLink: "https://juliana-rueda-portfolio.netlify.app",
        githubLink: "https://github.com/PowerSystem2024/The-Gods-Of-Programming/tree/main/Portfolio/Portfolio-JulianaRueda"
    },
])
