...
const title = 'Juliana Rueda';
const descripcion = 'Soy manicura profesional y futura técnica universitaria en Programación - UTN';
const residencia = 'Marcos Paz, Buenos Aires, Argentina';
...
const redesSociales = [
  { id: 1, name: 'github', src: github, url: 'https://github.com/julianarueda' }
];
</script>
