...
const intereses = ref([
    'Cocina: Disfruto de la cocina dulce y me especializo en la cocina de facturas y tortas.',
    ...
    'Aprender: Siempre le dedico el tiempo de poder absorber distintos conociemiento tanto de matematica, programacion, cocina y historia para poder seguir mejorando mi creatividad y aprendizaje.'
...
.fondo-lava {
  ...
  width: 100%;
  height: 100%;
  z-index: 1; /* Asegura que esté en una capa inferior */
  overflow: hidden;
}
</style>