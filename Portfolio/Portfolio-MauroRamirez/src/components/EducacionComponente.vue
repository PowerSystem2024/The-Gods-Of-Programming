...
const educacion = ref([
  {fecha: '2017', title: 'Título secundario', descripcion: 'EES N° 4', enlace:''},
  {fecha: '2023', title: 'Profesor de Matemática', descripcion: 'Instituto de formación docente técnica N°44', enlace:''},
  {fecha: '2023', title: 'Cheff Profesional', descripcion: 'Especialización en panadería, pastelería y barman. Escuela Gourmet', enlace:''},
  ]);
</script>
