...
import proyecto2 from '/src/assets/parqueo.png';
import proyecto3 from '/src/assets/EspacioPublicitario.png';
...
misProyectos.value = ([
    //esto es un array de objetos que contiene información sobre los proyectos
    {
        id: 1,
        src: proyecto1,
        titulo: "Aplicación Easy Soft",
        descripcion: "Creé una aplicación móvil para restaurantes, para que puedan administrar su carta de comidas.",
    ...
    },
    {
        id: 2,
        src: proyecto2,
        titulo: "Aplicacion para buscar estacionamiento",
        descripcion: "Diseñé y desarrollé una plataforma para buscar estacionamiento en la Ciudad de Resistencia, Chaco.",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
    {
        id: 3,
        src: proyecto3,
        titulo: "Pagina para publicitar",
        descripcion: "Construí una pagina para publicitar en los edificios de la Ciudad de Buenos Aires",
        projectoLink: "https://www.google.com.ar",
        githubLink: "https://github.com/usuario/proyecto"
    },
...
.galeria {
    ...
    background: linear-gradient(-45deg, #021526, #000000, #6666669a, #E2E2B6);
