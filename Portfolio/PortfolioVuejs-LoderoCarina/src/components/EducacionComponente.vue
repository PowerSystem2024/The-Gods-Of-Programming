...
const educacion = ref([
  ...
  {fecha: '2023', title: 'Diplomatura Universitaria en Estrategias de Gestión', descripcion: 'El programa se estructura en 10 módulos y brinda una serie de habilidades y prácticas de estrategias a partir del liderazgo y el coaching, orientados hacia la participación, el liderazgo, la colaboración, con el fin de mejorar la comunicación, la coordinación de acciones, el bienestar en las personas y los resultados', enlace:'http:www.direccion.com'},
  {fecha: '2023', title: 'Diplomatura Universitaria en Liderazgo y Coaching', descripcion: 'Esta Diplomatura brinda conocimientos y herramientas para profesionales, empresarios/as, emprendedores/as y público en general de distintos ámbitos, con el fin de alcanzar y superar los desafíos que el mundo actual trae y elegir mejores oportunidades de desarrollo.', enlace:'http:www.direccion.com'},
  {fecha: '2022', title: 'Introducción a base de datos con MySQL; Big Data / Data Analytics', descripcion: 'Complete cursos para formarme como analista de Datos', enlace:'http:www.direccion.com'},
  {fecha: '2022', title: 'Curso de Introducción a la Programación', descripcion: 'Completé un curso en línea sobre fundamentos de programación, donde aprendí el lenguaje Python.', enlace:'http:www.direccion.com'}
]);
</script>
