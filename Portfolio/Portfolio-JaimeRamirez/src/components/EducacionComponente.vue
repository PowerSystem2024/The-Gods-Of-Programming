...
const educacion = ref([
  {fecha: '2024', title: 'Profesor de Matemática', descripcion: 'Instituto Superior de Formación Docente y Técnica N° 44', enlace:''},
  {fecha: '2024', title: 'Full Stack Python', descripcion: 'Codo a codo – Agencia de Habilidades para el Futuro', enlace:''},
  {fecha: '2023', title: 'Diplomatura en Ciencias Sociales Computacionales', descripcion: 'Universidad Nacional Guillermo Brown.', enlace:''},
  {fecha: '2009-Presente', title: 'Ingeniería en Sistemas de Información', descripcion: 'Universidad Tecnológica Nacional', enlace:''},
  ]);
</script>
