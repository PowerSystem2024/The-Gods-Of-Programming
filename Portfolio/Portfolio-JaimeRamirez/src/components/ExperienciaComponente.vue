...
const fecha = 'Desde Enero 2020 / Julio 2024';
const experiencias = ref([
    { id: 1, src: icono1, parrafo: 'Desarrollador Full Stack en Java' },
    { id: 2, src: icono2, parrafo: 'Profesor del trayecto formativo Programación Backend de Coderhouse' },
    { id: 3, src: icono3, parrafo: 'Becario de la Universidad Tecnológica Nacional del Proyecto “Análisis del crecimiento demográfico urbano a partir de la estructura e grafos asociados a una colección temporal de imágenes satelitales nocturnas”' },
]);
</script>
