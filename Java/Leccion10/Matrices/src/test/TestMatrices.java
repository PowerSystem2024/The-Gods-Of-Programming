...
//        }
        ...
        personas[0][1] = new Persona("Carina");
        personas[1][0] = new Persona("Martina");
        personas[1][1] = new Persona("Mateo");
        personas[2][0] = new Persona("Juan Pablo");
        personas[2][1] = new Persona("Julieta");
