        ...
        if((dia != 0) && (dia <= 30)) {
            if ((mes!=0)&& (mes<=12)) {
                ...
                System.out.println("La fecha ingresada es: "+dia+"/"+mes+"/"+anio);
                        ...
                        System.out.println("Fecha inncorrecta, año incorrecto " );
                        }
            }
            else {
                     System.out.println("Fecha inncorrecta, mes incorrecto " );
                     }
        }
        else {
                 System.out.println("Fecha inncorrecta, dia incorrecto " );
                 }
